/*
 * @file	CNMutableRecordValue.swift
 * @brief	Define CNMutableRecordValue class
 * @par Copyright
...
public class CNMutableRecordValue: CNMutableValue
{
	private var mFieldTypes:	CNInterfaceType
	private var mDictionaryValue:	Dictionary<String, CNMutableValue>

	public init(fieldTypes ftypes: CNInterfaceType, sourceDirectory srcdir: URL, cacheDirectory cachedir: URL){
		mFieldTypes	 = ftypes
		mDictionaryValue = [:]
