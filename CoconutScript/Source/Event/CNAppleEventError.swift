/**
 * @file	CNAppleEventError.swift
 * @brief	Define CNAppleEventError class
 * @par Copyright
...
public class CNAppleEventError {
	...
	public static func message(errorCode ecode: Int) -> String? {
		return descriptionForError[ecode]
	}
}
